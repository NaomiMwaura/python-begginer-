...
countries2 = ["Kenya", "uganda", "Tanzania",["south africa","zambia", "zimbambwe"],["mexico", "cuba", "jamaica", "Brazil"]]
countries[2].insert(1, "England")
print(countries)
...
print(countries2[4])
print(countries[2][2])
print(countries2[4][1], countries2[4][3])
countries.extend(countries2[4])
print(countries)
countries2.insert(4, countries[3])
print(countries2)
countries2.insert(-1, countries[1])
print(countries2)
